...
public:
    scoped_interpreter( boost::filesystem::path so_vm,bool init_signal_handlers = true):lib(so_vm, dll::load_mode::append_decorations) {
...
int main () {
    scoped_interpreter vm("/usr/local/opt/python/Frameworks/Python.framework/Versions/3.7/lib/libpython3.7m.dylib");
